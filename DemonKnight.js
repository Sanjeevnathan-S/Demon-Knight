...
flyImg.src='/Demon-Knight/Demon/Sprites/with_outline/FLYING.PNG';
deathImg.src='/Demon-Knight/Demon/Sprites/with_outline/DEATH.PNG';
hurtImg.src='/Demon-Knight/Demon/Sprites/with_outline/HURT.PNG';
idleImg.src='/Demon-Knight/Demon/Sprites/with_outline/IDLE.PNG';
attackImg.src='/Demon-Knight/Demon/Sprites/with_outline/ATTACK.PNG';
flyImg.onload = () => {
  enemyAnimations = {
...
walkImage.src = '/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Run.PNG';
const idleImage = new Image();
idleImage.src = '/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Idle.PNG';
const slideImage=new Image();
slideImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_SlideFull.PNG';
const attackImage=new Image();
attackImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Attack.PNG';
const attack2Image=new Image();
attack2Image.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Attack2.PNG';
const crouchAttackImage=new Image();
crouchAttackImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_CrouchAttack.PNG';
const crouchImage=new Image();
crouchImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Crouch.PNG';
const comboImage=new Image();
comboImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_AttackCombo2hit.PNG';
const dashImage=new Image();
dashImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Dash.PNG';
const deathImage=new Image();
deathImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Death.PNG';
const hitImage=new Image();
hitImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Hit.PNG';
const jumpImage=new Image();
jumpImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_Jump.PNG';
const fallImage=new Image();
fallImage.src='/Demon-Knight/FreeKnight_v1/Colour1/Outline/120x80_PNGSheets/_JumpFallInBetween.PNG';
