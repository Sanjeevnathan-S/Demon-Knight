...
walkImage.src = 'https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Run.png';
const idleImage = new Image();
idleImage.src = 'https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Idle.png';
const slideImage=new Image();
slideImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_SlideFull.png';
const attackImage=new Image();
attackImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Attack.png';
const attack2Image=new Image();
attack2Image.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Attack2.png';
const crouchAttackImage=new Image();
crouchAttackImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_CrouchAttack.png';
const crouchImage=new Image();
crouchImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Crouch.png';
const comboImage=new Image();
comboImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_AttackCombo2hit.png';
const dashImage=new Image();
dashImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Dash.png';
const deathImage=new Image();
deathImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Death.png';
const hitImage=new Image();
hitImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Hit.png';
const jumpImage=new Image();
jumpImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_Jump.png';
const fallImage=new Image();
fallImage.src='https://github.com/Sanjeevnathan-S/Demon-Knight/blob/main/FreeKnight_v1/_JumpFallInBetween.png';
